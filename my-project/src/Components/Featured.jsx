        ...
        filter.map((item) => (
          ...
          <div className="flex flex-col justify-center border  pb-12 pt-5  relative overflow-hidden bg-[#e9e9ec]  rounded-t-lg ">
              ...
              <div className="flex gap-5 absolute top-2 -left-36  duration-700 group-hover:left-2 ">
                <p className='border p-2 rounded-full bg-[#e1e1eb]'><RiShoppingCartLine />  </p>
                <p className='border p-2 rounded-full bg-[#e1e1eb]'> <FaRegHeart /></p>
                <img className='border p-2 rounded-full bg-[#e1e1eb] ' src={Plus} alt="" />
              </div>
          </div>
