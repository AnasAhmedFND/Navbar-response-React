...
const TwoTrending = () => {
  ...
  return (
    <>
      <div className="pb-10">
        <h1 className='mt-16 text-center font-bold text-2xl font-josefin'>Trending Products</h1>
      
        <div className="container mx-auto mt-10  flex justify-between ">
        { apiProduct.map((item) => (

            <div className="p-2 shadow-xl w-[250px] ">
        ...
        <div className="mt-5 container mx-auto flex gap-5  ">
          <div className=" w-[330px] bg-[#FFF6FB] p-5 h-[210px]        ">
          ...
          <div className=" w-[330px] bg-[#ececf2] p-5 h-[210px]  items-end      ">
            <h2 className='text-xl font-bold font-josefin '>23% off in all products</h2>
            <p className='text-primary'>Shop Now</p>
